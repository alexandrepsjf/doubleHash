 ...
 * @author alexandre
 */
public class PrepararPertinenciaAction implements Action {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        request.setAttribute("elementos", leitor.getListaElementos());
        request.setAttribute("url", fileName);

        try {
            request.getRequestDispatcher("prepararPertinencia.jsp").forward(request, response);
