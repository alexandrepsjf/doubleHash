 ...
 * @author alexandre
 */
public class CriarInterAction implements Action {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Group interSection = leitor.getGroupByName(a).intersection(leitor.getGroupByName(b));
        request.setAttribute("resultado", interSection.getGrupo());
