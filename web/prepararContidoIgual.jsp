            ...
            <div class="container white-text">
                ...
                <div class="home-content" >                        
                    <div class="center text-info ">
                        <h1 class="white-text">Lista de conjuntos para Continência</h1>
                                                <h3 class="white-text">Esta operação só pode ser realizada entre conjuntos.Não se aplica a elementos.</h3>

                    </div>                        
                    <form method="post" action="FrontController?action=VerificarContidoIgual&url=${url}" name="tabelaTotal">
