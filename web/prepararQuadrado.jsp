            ...
            <div class="container white-text">
                ...
                <div class="home-content" >                        
                    <div class="center text-info ">
                        <h1 class="center text-info ">Lista de conjuntos para criar relação Quadrado de </h1>

                    </div>                        
                    <form method="post" action="FrontController?action=CriarQuadrado&url=${url}" name="tabelaTotal">
