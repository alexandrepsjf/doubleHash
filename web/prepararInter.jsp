            ...
            <div class="container white-text">
                ...
                <div class="home-content" >                        
                    <div class="center text-info ">
                        <h1 class="white-text">Lista de conjuntos para Verificar a Interseção</h1>
                        <h3 class="white-text">Esta operação só pode ser realizada entre conjuntos.Não se aplica a elementos.</h3>

                    </div>                        
                    <form method="post" action="FrontController?action=CriarInter&url=${url}" name="tabelaTotal">
                    ...
                    <div>
                        <form method="post" action="FrontController?action=CriarInterMulti&url=${url}"> 
                            <div class="row col-lg-offset-3 col-lg-6">  
                                ...
                                <div> 
                                    <button type="submit" class="btn btn-warning"> Verificar Vários</button></h5></div>
                            </div>  
                        </form>
                    </div> 
                </div>
