            ...
            <div class="container white-text">
                ...
                <div class="home-content" >                        
                    <div class="center text-info ">
                        <h1>Lista de conjuntos para identificar as Partes P(X)</h1>
                        <h3 class="white-text">Esta operação só pode ser realizada entre conjuntos.Não se aplica a elementos.</h3>
                    </div>                        
                    <form method="post" action="FrontController?action=CriarPartes&url=${url}" name="tabelaTotal">
                        ...
                        <div class="row white-text">     
                            <div> <button type="submit" class="btn btn-warning "> Identificar</button></h5></div>
                        </div>
                    </form>
